// Cache functionality for chat messages
// Import dependencies
...
export class MessageCache extends BaseCache {
  ...
  // Cache functionality for adding chat List
  ...
  // Cache functionality for adding chat message
  ...
  // Cache functionality for adding chat users
