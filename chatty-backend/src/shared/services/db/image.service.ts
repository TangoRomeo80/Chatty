// DB service for image related functionalities
// import dependencies
...
class ImageService {
  // method to add user profile image to db
  ...
  // method to add user background image to db
  ...
  // method to get user profile image from db
